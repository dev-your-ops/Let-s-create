...
<script>
import ButtonDesc from '@/ui/Button/Desc';
import FormDesc from '@/ui/form/Desc';
import SpinnerDesc from '@/ui/Spinner/Desc';
import PrismDesc from '@/ui/Prism/Desc';
import BadgeDesc from '@/ui/Badge/Desc';
